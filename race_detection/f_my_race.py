...
2. input an image where only one face is visible (use model face detection to extract an image with only the face)
...
class Race_Model():
    ...
    def loadModel(self):
        ...
        '''
        race_model.load_weights('D:\Face-Emotion-and-Info-Detection/race_detection/race_model_single_batch.h5')	
        return race_model
        #--------------------------
